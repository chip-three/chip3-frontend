            ...
            <>
                ...
                <div className="mt-[26px] resultCard mx-3">
                  ...
                  <div className="row flex justify-center w-full">
                    <div
                      ...
                      style={{ color: status2style(data.fixture.status.long) }}
                    >
                      ...
                      <div className="flexwrap">
                        {schedules.map((item, key) => (
                          <label
                            ...
                            className="flex card btn modal-button"
                          >
                            <div className="text-[12px]">
                              {simpleaddress(item[0])}
                            </div>
                            {/* <div className='text-[12px]'>Description: {item[2]}</div> */}
                            <div className="text-[12px]">
                              {teamidtostring(item[6].toString())}
                            </div>
                            <div className="text-[12px]">
                              {ethers.utils.formatEther(item[3].toString())}
                            </div>
                          </label>
                        ))}
                      </div>
              ...
              <div className="flex flex-col">
                <div>
                  ...
                  <div
                    className="flex mt-[20px] flex-row justify-between gap-[10px] mx-[10px]"
                    style={{ fontSize: "14px" }}
                  >
                    <label
                      htmlFor="modal-1"
