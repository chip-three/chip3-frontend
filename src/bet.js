...
function Bet() {
    ...
    useEffect(()=>{
      setshowmatchloading(true)
        ...
        axios.post( `${serverURL}/history_match`, {
          matchID: id.toString(),
          betId: id1.toString()
        }).then(async res=>{
            let temp = []
          ...
          <>
            ...
            <div className="mt-[26px] resultCard mx-3">
                ...
                <div className="row flex justify-center w-100">
                    <p className="text-[15px] max-sm:text-[10px]">{matchdata.fixture.venue.name}&nbsp;&nbsp;&nbsp;{matchdata.fixture.venue.city}</p>
                </div>
                {
...

            {
                ...
                <div>
                    ...
                    <div className="flex mt-[20px] flex-wrap justify-center">
                        ...
                        <label onClick={e=>betlose()} className="btn w-[120px] max-sm:m-[3px] ">
                        {
                          showloadingbutton1&&
                          <div className="mr-[3px]">
                            <div role="status">
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg m-2">
              {
                 ...
                 <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    ...
                    <tr key={key} className="border-b dark:bg-gray-900 dark:border-gray-700">
                        <th scope="row" className="px-6 py-4 font-medium text-gray whitespace-nowrap dark:text-white">
                        { matchdata.teams.away.name} vs { matchdata.teams.home.name} 
                        </th>
