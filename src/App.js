...
import { menustatu, coinbalance, matchpage, tbetpage, mbetpage } from './atom'
        ...
        <div className="App">
          ...
          <header className="App-header">
            ...
            <div className='menubar flex text-[17px]'>
              <span className={cn('mx-2 hoveryellow hover:scale-110 active:scale-100', matchclick && 'focusyellow scale-110' )} onClick={e=>{navigate('/');}}>Matches</span>
              <span className={cn('mx-2 hoveryellow hover:scale-110 active:scale-100', tmatchclick && 'focusyellow scale-110' )} onClick={e=>{navigate('/today_bettings');}}>Today's Bets</span>
              <span className={cn('mx-2 hoveryellow hover:scale-110 active:scale-100', bmatchclick && 'focusyellow scale-110' )} onClick={e=>{gethistory();}}>My Bets</span>
